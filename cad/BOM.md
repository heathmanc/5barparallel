...
| 1 | Top plate | BCR-05 | 150 × 92 × 10 (+4 Ø12×40 standoffs) |

## Fasteners (McMaster-Carr — stable catalog)

| Qty | Part | Use |
|---|---|---|
| 8 | M6 × 16 SHCS (Ø90 BCD) | Motor flange → carriage, fitted **from below** through the flange into M6 inserts/taps in the carriage |
...
| 12 | M5 × 16 SHCS | Cradle fin flanges → deck underside (3 per fin, deck holes Ø5.2 thru) |
| 16 | M4 × 30 SHCS + nyloc + washers | Bearing caps — 4 per bore, top+bottom cap bolted **through** each plate on the Ø58 BCD (2 bores × 2 plates) |
| 2 | M25×1.5 shaft locknut (or KM5 + tab washer) | Shoulder bearing preload, above the upper cap |
| 8 | M5 × 16 SHCS | Deck ↔ top-plate standoffs (4 per plate) |
