...
COMMISSIONING_CONSTANTS: List[PlcConstant] = [
    ...
    PlcConstant("HOME_OFFSET_L", "DINT", 0, "steps", "Left switch angle * STEPS_PER_DEG (nominal 3748). Measured."),
    PlcConstant("HOME_OFFSET_R", "DINT", 0, "steps", "Right switch angle * STEPS_PER_DEG (nominal 1052). Measured."),
